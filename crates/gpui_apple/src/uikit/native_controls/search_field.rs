...
pub unsafe fn set_native_search_field_sends_immediately(_field: id, _sends: bool) {}

/// No-op on iOS.
pub unsafe fn set_native_search_field_sends_whole_string(_field: id, _sends: bool) {}
