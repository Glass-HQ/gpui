...
pub unsafe fn create_native_text_field(placeholder: &str) -> id {
    unsafe {
...
pub unsafe fn create_native_secure_text_field(placeholder: &str) -> id {
    unsafe {
...
/// Sets the text value.
pub unsafe fn set_native_text_field_string_value(field: id, value: &str) {
    unsafe {
...
pub unsafe fn get_native_text_field_string_value(field: id) -> String {
    unsafe {
...
pub unsafe fn set_native_text_field_placeholder(field: id, placeholder: &str) {
    unsafe {
        let _: () = msg_send![field, setPlaceholder: ns_string(placeholder)];
        let _: () = msg_send![field, setAccessibilityHint: ns_string(placeholder)];
    }
...
/// Sets the font size.
pub unsafe fn set_native_text_field_font_size(field: id, size: f64) {
    unsafe {
...
pub unsafe fn set_native_text_field_alignment(field: id, alignment: u64) {
    unsafe {
...
pub unsafe fn set_native_text_field_bezel_style(field: id, style: i64) {
    unsafe {
...
pub unsafe fn set_native_text_field_delegate(
    field: id,
...
pub unsafe fn release_native_text_field_delegate(delegate_ptr: *mut c_void) {
    unsafe {
...
pub unsafe fn release_native_text_field(field: id) {
    unsafe {
        if !field.is_null() {
