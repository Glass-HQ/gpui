...
pub unsafe fn create_native_sidebar_view(_width: f64, _min_width: f64, _max_width: f64) -> id {
    unsafe {
...
pub unsafe fn configure_native_sidebar_window(_view: id, _window: *mut c_void) {}

/// Sets the sidebar width by updating the frame.
pub unsafe fn set_native_sidebar_width(_view: id, _width: f64) {
    // Frame management handled by set_native_view_frame at the element layer.
}

/// Sets sidebar collapsed state by hiding/showing.
pub unsafe fn set_native_sidebar_collapsed(view: id, collapsed: bool) {
    unsafe {
...
pub unsafe fn set_native_sidebar_items(_view: id, _items: *mut c_void) -> *mut c_void {
    std::ptr::null_mut()
}

/// No-op on iOS.
pub unsafe fn set_native_sidebar_header(_view: id, _title: &str) {}

/// Embeds a surface view in the sidebar content area.
pub unsafe fn embed_surface_view_in_sidebar(host_view: id, surface_view: id) {
    unsafe {
...
pub unsafe fn set_native_sidebar_background_color(view: id, r: f64, g: f64, b: f64, a: f64) {
    unsafe {
...
pub unsafe fn clear_native_sidebar_background_color(view: id) {
    unsafe {
...
pub unsafe fn release_native_sidebar_target(_target: *mut c_void) {}

/// Releases the sidebar view.
pub unsafe fn release_native_sidebar_view(view: id) {
    unsafe {
        if !view.is_null() {
