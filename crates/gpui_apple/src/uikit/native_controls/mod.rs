...
pub unsafe fn attach_native_view_to_parent(view: id, parent: id) {
    unsafe {
...
pub unsafe fn set_native_view_frame(
    view: id,
...
pub unsafe fn remove_native_view_from_parent(view: id) {
    unsafe {
...
pub unsafe fn release_object(obj: id) {
    if !obj.is_null() {
