...
pub unsafe fn create_native_visual_effect_view() -> id {
    unsafe {
...
pub unsafe fn set_native_visual_effect_material(view: id, material: i64) {
    unsafe {
...
pub unsafe fn set_native_visual_effect_blending_mode(_view: id, _mode: i64) {}

/// No-op on iOS — state (active/inactive) is automatic.
pub unsafe fn set_native_visual_effect_state(_view: id, _state: i64) {}

/// No-op on iOS — emphasis is not separately configurable.
pub unsafe fn set_native_visual_effect_emphasized(_view: id, _emphasized: bool) {}

/// Sets the corner radius.
pub unsafe fn set_native_visual_effect_corner_radius(view: id, radius: f64) {
    unsafe {
...
pub unsafe fn release_native_visual_effect_view(view: id) {
    unsafe {
        if !view.is_null() {
