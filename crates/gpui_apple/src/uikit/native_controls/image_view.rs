...
pub unsafe fn create_native_image_view() -> id {
    unsafe {
...
pub unsafe fn set_native_image_view_sf_symbol(view: id, symbol_name: &str) {
    unsafe {
...
pub unsafe fn set_native_image_view_sf_symbol_config(
    view: id,
    symbol_name: &str,
    point_size: f64,
    weight: i64,
...
pub unsafe fn set_native_image_view_image_from_data(view: id, data: &[u8]) {
    unsafe {
...
/// Clears the image.
pub unsafe fn clear_native_image_view_image(view: id) {
    unsafe {
...
pub unsafe fn set_native_image_view_scaling(view: id, scaling: i64) {
    unsafe {
...
pub unsafe fn set_native_image_view_content_tint_color(view: id, r: f64, g: f64, b: f64, a: f64) {
    unsafe {
...
pub unsafe fn set_native_image_view_enabled(view: id, enabled: bool) {
    unsafe {
...
pub unsafe fn release_native_image_view(view: id) {
    unsafe {
        if !view.is_null() {
