...
pub unsafe fn create_native_stack_view(orientation: i64) -> id {
    unsafe {
...
pub unsafe fn set_native_stack_view_spacing(view: id, spacing: f64) {
    unsafe {
...
pub unsafe fn set_native_stack_view_alignment(view: id, alignment: i64) {
    unsafe {
...
pub unsafe fn set_native_stack_view_distribution(view: id, distribution: i64) {
    unsafe {
...
pub unsafe fn set_native_stack_view_edge_insets(
    view: id,
    top: f64,
    left: f64,
    bottom: f64,
...
pub unsafe fn add_native_stack_view_arranged_subview(stack: id, subview: id) {
    unsafe {
...
pub unsafe fn remove_all_native_stack_view_arranged_subviews(stack: id) {
    unsafe {
...
pub unsafe fn set_native_stack_view_detach_hidden(_view: id, _detach: bool) {}

/// Releases a UIStackView.
pub unsafe fn release_native_stack_view(view: id) {
    unsafe {
        if !view.is_null() {
