...
pub unsafe fn set_native_table_column_title(_scroll_view: id, _title: &str) {}

/// Sets table column width. No-op on iOS.
pub unsafe fn set_native_table_column_width(_scroll_view: id, _width: f64) {}
...
/// Sets row height.
pub unsafe fn set_native_table_row_height(table: id, row_height: f64) {
    unsafe {
...
pub unsafe fn set_native_table_row_size_style(_table: id, _row_size_style: i64) {}

/// Sets table style (plain/grouped/inset).
pub unsafe fn set_native_table_style(_table: id, _style: i64) {
    // Style must be set at init time on iOS. No-op for now.
}

/// Sets selection highlight style.
pub unsafe fn set_native_table_selection_highlight_style(_table: id, _style: i64) {}

/// No-op on iOS.
pub unsafe fn set_native_table_grid_style(_table: id, _grid_style_mask: u64) {}

/// No-op on iOS.
pub unsafe fn set_native_table_uses_alternating_rows(_table: id, _uses: bool) {}

/// Sets whether multiple selection is allowed.
pub unsafe fn set_native_table_allows_multiple_selection(table: id, allows: bool) {
    unsafe {
...
pub unsafe fn set_native_table_show_header(_table: id, _show_header: bool) {}
...
pub unsafe fn release_native_table_view(table: id) {
    unsafe {
        if !table.is_null() {
