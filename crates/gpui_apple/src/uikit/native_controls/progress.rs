...
pub unsafe fn create_native_progress_indicator() -> id {
    unsafe {
...
pub unsafe fn set_native_progress_style(_indicator: id, _style: i64) {
...
pub unsafe fn set_native_progress_indeterminate(_indicator: id, _indeterminate: bool) {
...
pub unsafe fn set_native_progress_value(indicator: id, value: f64) {
    unsafe {
...
pub unsafe fn set_native_progress_min_max(_indicator: id, _min: f64, _max: f64) {
...
pub unsafe fn start_native_progress_animation(_indicator: id) {}

/// Stop animation (no-op for UIProgressView).
pub unsafe fn stop_native_progress_animation(_indicator: id) {}

/// Sets whether the view is displayed when stopped.
pub unsafe fn set_native_progress_displayed_when_stopped(indicator: id, displayed: bool) {
    unsafe {
...
pub unsafe fn release_native_progress_indicator(indicator: id) {
    unsafe {
