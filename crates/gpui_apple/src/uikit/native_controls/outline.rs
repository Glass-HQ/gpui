...
pub unsafe fn sync_native_outline_column_width(_table: id) {}

pub unsafe fn set_native_outline_highlight_style(_table: id, _style: i64) {}

pub unsafe fn set_native_outline_row_height(table: id, row_height: f64) {
    unsafe {
...
pub unsafe fn release_native_outline_view(table: id) {
    unsafe {
        if !table.is_null() {
