...
/// 0 = bar, 1 = spinner.
pub unsafe fn set_native_progress_style(indicator: id, style: i64) {
    unsafe {
...
pub unsafe fn set_native_progress_indeterminate(indicator: id, indeterminate: bool) {
    unsafe {
...
pub unsafe fn set_native_progress_min_max(indicator: id, min: f64, max: f64) {
    unsafe {
...
pub unsafe fn start_native_progress_animation(indicator: id) {
    unsafe {
...
pub unsafe fn stop_native_progress_animation(indicator: id) {
    unsafe {
