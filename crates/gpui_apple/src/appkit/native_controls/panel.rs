...
pub unsafe fn create_native_panel(
    width: f64,
    height: f64,
...
pub unsafe fn get_native_panel_content_view(panel: id) -> id {
...
pub unsafe fn get_native_panel_content_host_view(panel: id) -> id {
    unsafe {
        let content_view: id = msg_send![panel, contentView];
        if content_view == nil {
            return nil;
...
pub unsafe fn show_native_panel(panel: id) {
    unsafe {
...
pub unsafe fn show_native_panel_centered(panel: id) {
    unsafe {
...
pub unsafe fn set_native_panel_frame_origin(panel: id, x: f64, y: f64) {
    unsafe {
...
pub unsafe fn set_native_panel_frame_top_left(panel: id, x: f64, y: f64) {
    unsafe {
...
pub unsafe fn set_native_panel_size(panel: id, width: f64, height: f64) {
    unsafe {
...
pub unsafe fn set_native_panel_frame(
    panel: id,
    x: f64,
    y: f64,
    width: f64,
...
/// Closes the panel.
pub unsafe fn close_native_panel(panel: id) {
    unsafe {
...
pub unsafe fn hide_native_panel(panel: id) {
    unsafe {
...
pub unsafe fn is_native_panel_visible(panel: id) -> bool {
    unsafe {
...
pub unsafe fn get_toolbar_item_screen_frame(window: id, item_identifier: &str) -> Option<NSRect> {
    unsafe {
...
pub unsafe fn release_native_panel(panel: id, delegate_ptr: *mut c_void) {
    unsafe {
