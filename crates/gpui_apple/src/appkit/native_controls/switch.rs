...
pub unsafe fn create_native_switch() -> id {
    unsafe {
...
pub unsafe fn set_native_switch_state(switch: id, checked: bool) {
    unsafe {
...
pub unsafe fn set_native_switch_action(switch: id, callback: Box<dyn Fn(bool)>) -> *mut c_void {
    unsafe {
...
pub unsafe fn release_native_switch_target(target: *mut c_void) {
    unsafe {
        if !target.is_null() {
...
pub unsafe fn release_native_switch(switch: id) {
    unsafe {
