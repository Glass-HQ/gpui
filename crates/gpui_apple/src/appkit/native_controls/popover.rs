...
///   - 2 = semitransient
pub unsafe fn create_native_popover(
    width: f64,
    height: f64,
    behavior: i64,
    on_close: Option<Box<dyn Fn()>>,
...
pub unsafe fn get_native_popover_content_view(popover: id) -> id {
    unsafe {
...
pub unsafe fn show_native_popover_relative_to_toolbar_item(popover: id, toolbar_item: id) {
    unsafe {
...
pub unsafe fn show_native_popover_relative_to_view(popover: id, view: id) {
    unsafe {
...
pub unsafe fn show_native_popover_relative_to_point(popover: id, view: id, x: f64, y: f64) {
    unsafe {
...
/// Closes the popover.
pub unsafe fn dismiss_native_popover(popover: id) {
    unsafe {
...
pub unsafe fn release_native_popover(popover: id, delegate_ptr: *mut c_void) {
    unsafe {
...
pub unsafe fn add_native_popover_label(
    content_view: id,
    text: &str,
    x: f64,
    y: f64,
...
pub unsafe fn add_native_popover_small_label(
    content_view: id,
    text: &str,
    x: f64,
    y: f64,
...
pub unsafe fn add_native_popover_icon_label(
    content_view: id,
    icon_name: &str,
    text: &str,
    x: f64,
...
pub unsafe fn add_native_popover_button(
    content_view: id,
    title: &str,
    x: f64,
    y: f64,
...
pub unsafe fn add_native_popover_separator(content_view: id, x: f64, y: f64, width: f64) -> id {
    unsafe {
...
pub unsafe fn add_native_popover_toggle(
    content_view: id,
    text: &str,
    checked: bool,
    x: f64,
...
pub unsafe fn add_native_popover_checkbox(
    content_view: id,
    text: &str,
    checked: bool,
    x: f64,
...
pub unsafe fn add_native_popover_progress(
    content_view: id,
    value: f64,
    max: f64,
    label: Option<&str>,
...
pub unsafe fn ns_color_for_platform_color(color: gpui::PlatformNativeColor) -> id {
    unsafe {
...
pub unsafe fn add_native_popover_color_dot(
    content_view: id,
...
pub unsafe fn add_native_popover_clickable_row(
    content_view: id,
    icon: Option<&str>,
    text: &str,
    detail: Option<&str>,
...
pub unsafe fn release_native_popover_switch_target(target: *mut c_void) {
    unsafe {
...
pub unsafe fn release_native_popover_checkbox_target(target: *mut c_void) {
    unsafe {
...
pub unsafe fn release_native_hover_row_target(target: *mut c_void) {
    unsafe {
        if !target.is_null() {
