...
pub unsafe fn create_native_segmented_control(
    labels: &[&str],
...
pub unsafe fn create_native_segmented_control_with_tracking_mode(
    labels: &[&str],
    selected_index: Option<usize>,
    tracking_mode: i64,
) -> id {
...
pub unsafe fn set_native_segmented_selected(control: id, index: Option<usize>) {
    unsafe {
...
pub unsafe fn set_native_segmented_border_shape(control: id, shape: i64) {
    unsafe {
...
pub unsafe fn set_native_segmented_control_size(control: id, size: u64) {
    unsafe {
...
pub unsafe fn set_native_segmented_image(control: id, segment: usize, symbol_name: &str) {
    unsafe {
        use super::super::ns_string;
...
pub unsafe fn set_native_segmented_action(
    control: id,
...
pub unsafe fn release_native_segmented_target(target: *mut c_void) {
    unsafe {
        if !target.is_null() {
...
pub unsafe fn release_native_segmented_control(control: id) {
    unsafe {
