...
pub fn is_glass_effect_available() -> bool {
...
pub unsafe fn create_native_glass_effect_view() -> id {
    unsafe {
...
/// Regular = 0, Clear = 1.
pub unsafe fn set_native_glass_effect_style(view: id, style: i64) {
    unsafe {
...
pub unsafe fn set_native_glass_effect_corner_radius(view: id, radius: f64) {
    unsafe {
...
pub unsafe fn set_native_glass_effect_tint_color(
    view: id,
    red: f64,
    green: f64,
    blue: f64,
...
pub unsafe fn clear_native_glass_effect_tint_color(view: id) {
    unsafe {
...
pub unsafe fn release_native_glass_effect_view(view: id) {
    unsafe {
        if view != nil {
