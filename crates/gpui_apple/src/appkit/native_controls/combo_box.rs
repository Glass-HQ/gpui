...
pub unsafe fn create_native_combo_box(items: &[&str], selected_index: usize, editable: bool) -> id {
    unsafe {
...
pub unsafe fn set_native_combo_box_items(combo: id, items: &[&str]) {
    unsafe {
...
pub unsafe fn set_native_combo_box_selected(combo: id, index: usize) {
    unsafe {
...
pub unsafe fn set_native_combo_box_string_value(combo: id, value: &str) {
    unsafe {
        use super::super::ns_string;
...
pub unsafe fn get_native_combo_box_string_value(combo: id) -> String {
    unsafe {
...
pub unsafe fn set_native_combo_box_editable(combo: id, editable: bool) {
    unsafe {
...
pub unsafe fn set_native_combo_box_completes(combo: id, completes: bool) {
    unsafe {
...
pub unsafe fn set_native_combo_box_delegate(
    combo: id,
...
pub unsafe fn release_native_combo_box_delegate(delegate_ptr: *mut c_void) {
    unsafe {
...
pub unsafe fn release_native_combo_box(combo: id) {
    unsafe {
